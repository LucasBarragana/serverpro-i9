...
export default function Footer() {
    return (
        <section id="Footer" className="bg-black text-white py-8 box-border">
            <div className="mx-auto relative px-10 sm:px-10 md:px-20 lg:px-40 max-w-screen-2xl">
                <div className="flex flex-col sm:flex-col md:flex-row lg:flex-row justify-between align-center ">
                    <div className="flex flex-row justify-around order-1 md:order-2 gap-10">
                        <div className="mb-4 md:mb-0 ">
                            ...
                            <Link href='#' className="block text-xs mb-2  md:text-xs hover:text-pink-500">Política de privacidade</Link>
                        </div>
                        <div className="mb-4 md:mb-0">
                    ...
                    <div className="flex flex-col items-center space-y-4 w-full md:w-2/5 order-2 md:order-1">
                        ...
                        <p className="text-center text-sm md:text-xs">
                            Plataforma para você criar e gerenciar seus formulários <br />
                            com segurança e praticidade.
                        </p>
                        <p className="text-center text-xs md:text-xs text-gray-200">
