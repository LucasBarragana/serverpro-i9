...
export default function VideoAbout() {
  ...
  return (
    <section id="VideoAbout">
      <div className="max-w-7xl mx-auto relative flex flex-col sm:mt-20 lg:flex-row justify-between items-center h-auto px-14 sm:px-6 lg:px-10">
        <motion.div
          ref={ref}
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-4xl text-white lg:mb-6 sm:mb-8">
        ...
        >
          <div className="relative w-full h-[200px] sm:h-[300px] md:w-[600px] md:h-[350px] lg:w-[600px] lg:h-[350px] shadow-lg">
            <Image
              src="/Video.png"
              alt="Image 1"
              layout="fill"
